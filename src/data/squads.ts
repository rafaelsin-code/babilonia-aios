...
export const squads: Squad[] = [
  ...
  },
  {
    ...
    agents: [
      ...
      { id: "avinash-kaushik", name: "Avinash Kaushik", role: "Web Analytics Evangelist", specialty: "Web Analytics e marketing digital", description: "Digital Marketing Evangelist por 15+ anos. See-Think-Do-Care.", frameworks: ["See-Think-Do-Care", "So What? Analysis", "Actionable KPIs"], personality: "Provocador, prático", color: "#60A5FA", initials: "AK" , photo: "https://unavatar.io/twitter/aaboracle", bio: "Digital Marketing Evangelist do Google por mais de 15 anos. Criador do framework See-Think-Do-Care e autor de \"Web Analytics 2.0\". Evangelista de métricas acionáveis contra vanity metrics."},
      { id: "peter-fader", name: "Peter Fader", role: "CLV Scientist", specialty: "Customer Lifetime Value", description: "Professor de Marketing em Wharton. Modelos probabilísticos de comportamento.", frameworks: ["CLV Models", "Customer-Based Valuation", "Probabilistic Models"], personality: "Acadêmico, rigoroso", color: "#34D399", initials: "PF" , bio: "Professor de Marketing em Wharton e co-fundador da Zodiac (adquirida pela Nike). Pioneiro em modelos probabilísticos de Customer Lifetime Value que transformaram como empresas valorizam clientes."},
      { id: "sean-ellis", name: "Sean Ellis", role: "Growth Hacking Pioneer", specialty: "Growth Hacking e Product-Market Fit", description: "Cunhou 'growth hacking' em 2010. Pirate Metrics AARRR.", frameworks: ["AARRR", "North Star Metric", "40% Test", "ICE Scoring"], personality: "Experimental, ágil", color: "#FBBF24", initials: "SE" , photo: "https://unavatar.io/twitter/SeanEllis", bio: "Cunhou o termo \"growth hacking\" em 2010. Primeiro Head of Growth do Dropbox, LogMeIn e Eventbrite. Criador das Pirate Metrics (AARRR) e do teste de 40% para product-market fit."},
      { id: "wes-kao", name: "Wes Kao", role: "Cohort Education Expert", specialty: "Educação cohort-based e audience", description: "Co-fundadora da Maven. Cursos cohort-based, spiky POV.", frameworks: ["Cohort Design", "Spiky POV", "Audience Building"], personality: "Rigorosa, criativa", color: "#A78BFA", initials: "WK" , photo: "https://unavatar.io/twitter/wes_kao", bio: "Co-fundadora da Maven, plataforma líder em cursos cohort-based. Criadora do conceito \"Spiky POV\" — pontos de vista afiados que diferenciam creators e educadores no mercado."},
      { id: "nick-mehta", name: "Nick Mehta", role: "Customer Success CEO", specialty: "Customer Success e retenção", description: "CEO da Gainsight. Definiu Customer Success como disciplina.", frameworks: ["Health Scores", "NRR", "Customer Journey Mapping"], personality: "Customer-obsessed", color: "#F87171", initials: "NM" , photo: "https://unavatar.io/twitter/nrmehta", bio: "CEO da Gainsight, a empresa que definiu Customer Success como disciplina de negócio. Autor de \"Customer Success\" e evangelista de Net Revenue Retention como métrica norte-estrela."},
      { id: "david-spinks", name: "David Spinks", role: "Community Strategist", specialty: "Estratégia de comunidade", description: "Fundador da CMX. Maior rede de profissionais de comunidade.", frameworks: ["SPACES Model", "Community-Led Growth", "Community ROI"], personality: "Comunitário, estratégico", color: "#FB7185", initials: "DSp" , photo: "https://unavatar.io/twitter/DavidSpinks", bio: "Fundador da CMX, a maior rede mundial de profissionais de comunidade. Criador do SPACES Model para estratégia de comunidade e pioneiro do conceito Community-Led Growth."},
    ],
    tasks: [
  ...
  },
  {
    ...
    agents: [
      ...
      { id: "joseph-campbell", name: "Joseph Campbell", role: "Mythologist", specialty: "Mitologia e Jornada do Herói", description: "O mestre da Jornada do Herói. Monomito, arquétipos mitológicos.", frameworks: ["Hero's Journey", "Monomyth", "Mythological Archetypes"], personality: "Sábio, profundo", color: "#E8C547", initials: "JCa" , bio: "Mitologista e autor de \"O Herói de Mil Faces\" (1949), obra que identificou o monomito — a Jornada do Herói presente em todas as culturas. Influenciou diretamente George Lucas na criação de Star Wars."},
      { id: "robert-mckee", name: "Robert McKee", role: "Story Structure Master", specialty: "Estrutura de roteiro e narrativa", description: "Autor de Story. Estrutura, beats, arcos narrativos.", frameworks: ["Story Structure", "Scene Beats", "Gap Theory"], personality: "Rigoroso, exigente", color: "#60A5FA", initials: "RM" , photo: "https://unavatar.io/twitter/McKeeStory", bio: "Autor de \"Story: Substance, Structure, Style and the Principles of Screenwriting\", considerado a bíblia da narrativa. Seu seminário formou 60+ vencedores do Oscar e 200+ vencedores do Emmy."},
      { id: "nancy-duarte", name: "Nancy Duarte", role: "Presentation Storyteller", specialty: "Apresentações e storytelling visual", description: "Sparkline, ressonância, storytelling para apresentações.", frameworks: ["Sparkline", "Resonate", "Visual Storytelling"], personality: "Visual, inspiradora", color: "#34D399", initials: "ND" , photo: "https://unavatar.io/twitter/nancyduarte", bio: "CEO da Duarte Inc, que criou o slide deck do \"An Inconvenient Truth\" de Al Gore. Autora de \"Resonate\" e criadora do Sparkline, framework que transforma apresentações em narrativas cativantes."},
      { id: "donald-miller-story", name: "Donald Miller", role: "Business Storyteller", specialty: "StoryBrand e business narrative", description: "Framework SB7 aplicado a negócios. Clareza de mensagem.", frameworks: ["SB7", "StoryBrand", "Business Narrative"], personality: "Claro, prático", color: "#FBBF24", initials: "DMs" , photo: "https://unavatar.io/twitter/donlomill", bio: "Autor de \"Building a StoryBrand\" (bestseller #1 NYT). Criou o framework SB7 que ajuda empresas a clarificar suas mensagens usando a estrutura narrativa universal do herói e seu guia."},
      { id: "kindra-hall", name: "Kindra Hall", role: "Personal Story Expert", specialty: "Narrativa pessoal e stories that stick", description: "Stories that Stick. Quatro tipos de história que todo negócio precisa.", frameworks: ["4 Story Types", "Stories That Stick", "Strategic Storytelling"], personality: "Calorosa, envolvente", color: "#A78BFA", initials: "KH" , photo: "https://unavatar.io/twitter/kindrahall", bio: "Autora de \"Stories That Stick\" e presidente da Steller Collective. Identificou os 4 tipos de história que todo negócio precisa: valor, fundador, propósito e cliente. Campeã nacional de storytelling."},
      { id: "keith-johnstone", name: "Keith Johnstone", role: "Improv Master", specialty: "Improvisação e espontaneidade", description: "Pai da improvisação moderna. Status, espontaneidade, aceitar ofertas.", frameworks: ["Status Games", "Yes And", "Spontaneity"], personality: "Espontâneo, playful", color: "#F87171", initials: "KJ" , bio: "Pai da improvisação moderna e autor de \"Impro\" (1979). Criador dos conceitos de status, espontaneidade e \"aceitar ofertas\" que revolucionaram teatro improvisacional e influenciam comunicação empresarial."},
      { id: "oren-klaff", name: "Oren Klaff", role: "Pitch Master", specialty: "Pitching e persuasão narrativa", description: "Pitch Anything. Neurofinance, frame control, intriga.", frameworks: ["STRONG Method", "Frame Control", "Neurofinance"], personality: "Intenso, estratégico", color: "#FB7185", initials: "OK" , photo: "https://unavatar.io/twitter/orenklaff", bio: "Autor de \"Pitch Anything\" e levantou mais de $400M em capital usando neurofinance. Criador do STRONG Method e do conceito de frame control para pitches de alto impacto."},
      { id: "carmine-gallo", name: "Carmine Gallo", role: "TED-Style Storyteller", specialty: "Apresentações estilo TED", description: "Talk Like TED. Técnicas dos melhores apresentadores do mundo.", frameworks: ["Talk Like TED", "Rule of Three", "Jaw-Dropping Moments"], personality: "Energético, didático", color: "#22D3EE", initials: "CG" , photo: "https://unavatar.io/twitter/caraboratorminegallo", bio: "Autor de \"Talk Like TED\" e colunista da Forbes. Analisou centenas de TED Talks para extrair as técnicas dos melhores apresentadores do mundo, incluindo a Rule of Three e Jaw-Dropping Moments."},
      { id: "annette-simmons", name: "Annette Simmons", role: "Trust Storyteller", specialty: "Stories que constroem confiança", description: "Whoever Tells the Best Story Wins. Seis tipos de história.", frameworks: ["Six Story Types", "Trust Building", "Influence Narratives"], personality: "Autêntica, empática", color: "#4ADE80", initials: "AS" , bio: "Autora de \"Whoever Tells the Best Story Wins\" e \"The Story Factor\". Identificou 6 tipos de história para construir confiança e influência, usados em negociações e liderança."},
      { id: "matthew-dicks", name: "Matthew Dicks", role: "Moth Storyteller", specialty: "Storytelling pessoal e competitivo", description: "54x Moth StorySLAM champion. Storyworthy. Homework for Life.", frameworks: ["Storyworthy", "Homework for Life", "5-Second Moment"], personality: "Vulnerável, envolvente", color: "#C084FC", initials: "MD" , photo: "https://unavatar.io/twitter/MatthewDicks", bio: "54x campeão do Moth StorySLAM e autor de \"Storyworthy\". Criador do exercício \"Homework for Life\" e do conceito \"5-Second Moment\" — a transformação interna que torna qualquer história memorável."},
      { id: "christopher-vogler", name: "Christopher Vogler", role: "Writer's Journey Expert", specialty: "Adaptação da Jornada do Herói para escrita", description: "The Writer's Journey. Adaptação prática de Campbell para roteiristas.", frameworks: ["Writer's Journey", "Character Archetypes", "Story Structure"], personality: "Prático, estruturado", color: "#E879F9", initials: "CV" , bio: "Autor de \"The Writer's Journey\", adaptação prática da Jornada do Herói de Campbell para roteiristas. Seu memo de 7 páginas na Disney mudou como Hollywood desenvolve histórias."},
    ],
    tasks: [
